              ...
              <div className="flex gap-2 flex-wrap">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                    selectedType === "all" ? "bg-primary-600 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                  }`}
                >
                  All
                </button>
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                    selectedType === "news" ? "bg-primary-600 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                  }`}
                >
                  News
                </button>
          ...
          {!loading && !error && (
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {notices.map((notice) => (
                <div
                  key={notice.id}
                  className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 cursor-pointer border-l-4 border-primary-500"
