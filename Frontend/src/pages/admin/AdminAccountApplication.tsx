...
import { useApplications, type AccountApplication } from "../../contexts/ApplicationContext"
import AdminDashboard from "./AdminDashboard"

const AdminAccountApplications: React.FC = () => {
  const { accountApplications, updateAccountApplicationStatus } = useApplications()
  ...
  const handleStatusUpdate = (id: string, status: AccountApplication["status"]) => {
    updateAccountApplicationStatus(id, status)
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <p>
                        <span className="font-medium">Deposit Frequency:</span> {selectedApplication.depositFrequency}
                      </p>
                    </div>
                  </div>
